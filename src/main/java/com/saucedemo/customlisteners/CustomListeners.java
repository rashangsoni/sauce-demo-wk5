...
import static com.saucedemo.utilities.Utility.takeScreenShot;
    ...
    public class CustomListeners implements ITestListener {
        ...
        public ExtentSparkReporter reporter; // on start method it is declared
        ...
        public void onTestFailure(ITestResult iTestResult) {
            ...
            test.addScreenCaptureFromPath(screenshotPath);  // we have to add report ng code here for practice.
        }
